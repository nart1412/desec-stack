...
def test_apex_update(api_user_lps_domain: DeSECAPIV1Client, auth_method, base_url):
    domain_name = api_user_lps_domain.domain
    ...
    def do_test(url, headers, params, expected_ipv4, expected_ipv6):
    ...
    do_test(base_url, headers, params, expected_ipv4=None if update6 else ipv4_net,
            expected_ipv6=ipv6_net if update6 else None)
    ...
    for extra_params, expected_ipv4, expected_ipv6 in [
        ...
        do_test(base_url + 'update/', headers, dict(params, **extra_params), expected_ipv4, expected_ipv6)


@pytest.mark.skip(reason="TODO")
def test_subdomain_update():
    # include a wildcard test case
    pass